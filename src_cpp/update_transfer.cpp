...
{ 
    ...
    sqlite3_bind_text(updateTransferStmt, 2, trans_update.type.c_str(), -1, SQLITE_TRANSIENT);
    sqlite3_bind_text(updateTransferStmt, 3, trans_update.recorded_at.c_str(), -1, SQLITE_TRANSIENT);
    sqlite3_bind_text(updateTransferStmt, 4, trans_update.updated_at.c_str(), -1, SQLITE_TRANSIENT);
    sqlite3_bind_text(updateTransferStmt, 5, trans_update.category.c_str(), -1, SQLITE_TRANSIENT);
    sqlite3_bind_text(updateTransferStmt, 6, trans_update.description.c_str(), -1, SQLITE_TRANSIENT);
    sqlite3_bind_int64(updateTransferStmt, 7, trans_update.amount);
    sqlite3_bind_text(updateTransferStmt, 8, trans_update.related_wallet_name.c_str(), -1, SQLITE_TRANSIENT);
    sqlite3_bind_int64(updateTransferStmt, 9, trans_update.id);
